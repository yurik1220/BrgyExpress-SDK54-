...
declare const __experimental_PricingTable: {
    (props: Without<WithClerkProp<{
        forOrganizations?: boolean;
        appearance?: _clerk_types.PricingTableTheme;
        checkoutProps?: Pick<_clerk_types.__experimental_CheckoutProps, "appearance">;
    } & {
